...
count if  missing_item_count>=10
		...
		*   N with data missing on 10 or more items - to be dropped
...
replace died = 0 if n_40007_0_0==.
	...
	* Recoding indicator for those that died after overall censorship date....
		/* Censoring in UKB at the time of analysis ended Nov 2015 - some deaths are recorded from particular death stat sources after that, 
...
/* NB: may return negative values - individuals have death dates prior to attendance dates;
	 these should be dropped from analyses
*/
